    ...
    return (
        <Form
            ...
            <Row>
                <Col>
                    <Form.Group>
                        <Form.Label className="form-group required control-label">Plakat</Form.Label>
                        <Form.Control
                            type="file"
                            accept="image/*"
                            {...register('poster')}
                ...
                <Col>
                    <Form.Group>
                        <Form.Label className="form-group required control-label">Tytuł filmu</Form.Label>
                        <Form.Control
                            type="text"
                    ...
                    <Form.Group className="mt-3">
                        <Form.Label className="form-group required control-label">Aktor</Form.Label>
                        <Form.Control
                            type="text"
                    ...
                    <Form.Group className="mt-3">
                        <Form.Label className="form-group required control-label">Gatunek</Form.Label>
                        <Form.Control
                            type="text"
                    ...
                    <Form.Group className="mt-3">
                        <Form.Label className="form-group required control-label">Stan</Form.Label>
                        <Form.Select
                    ...
                    <Form.Group className="mt-3">
                        <Form.Label className="form-group required control-label">Aktywny</Form.Label>
                        <Form.Select
