        ...
        <Form
            ...
            <Row>
                <Form.Group className="mt-3">
                    <Form.Label className="form-group required control-label">Kino</Form.Label>
                    <Form.Select
                        defaultValue={cinema?.cineplex_id ? cinema?.cineplex_id : ''}
                        aria-label="Wybierz kino"
            ...
            <Row>
                <Col>
                    <Form.Group className="mt-3">
                        <Form.Label className="form-group required control-label">Nazwa</Form.Label>
                        <Form.Control
                            type="text"
                ...
                <Col>
                    <Form.Group className="mt-3">
                        <Form.Label className="form-group required control-label">Typ</Form.Label>
                        <Form.Select
