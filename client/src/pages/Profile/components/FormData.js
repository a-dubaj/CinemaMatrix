    ...
    return (
        <Form id="form-edit" onSubmit={handleSubmit(onSubmitData)}>
            ...
            <Row className="mt-3">
                <Col>
                    <Form.Group>
                        <Form.Label className="form-group required control-label">Imię i nazwisko</Form.Label>
                        <Form.Control
                            type="text"
                    ...
                    <Form.Group className="mt-3">
                        <Form.Label className="form-group required control-label">Adres email</Form.Label>
                        <Form.Control
                            type="email"
                ...
                <Col>
                    <Form.Group>
                        <Form.Label className="form-group required control-label">Data urodzenia</Form.Label>
                        <Form.Control
                            type="date"
                    ...
                    <Form.Group className="mt-3">
                        <Form.Label className="form-group required control-label">Numer telefonu</Form.Label>
                        <Form.Control
                            type="text"
                            maxLength="10"
                            onInput={isNumber}
            ...
            <Row>
                <Form.Group className="mt-3">
                    <Form.Label className="form-group required control-label">Adres zamieszkania</Form.Label>
                    <Form.Control
                        type="text"
