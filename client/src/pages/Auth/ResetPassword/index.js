...
function ResetPassword(props) {
    ...
    useEffect(() => {
        if (isReset) {
            toast.success('Pozytywne odzyskanie hasło');
            history.push('/');
        }
    }, [history, isReset]);
            ...
            <div className="row align-items-center g-lg-5">
                ...
                <div className="col-md-10 mx-auto col-lg-5">
                    <form onSubmit={handleSubmit(onSubmit)} className="p-4 p-md-5 border rounded-3 bg-light">
                        <h3 className="text-center">Wprowadz nowe hasło</h3>
                        ...
                        <div className="form-floating mb-3">
                            ...
                            />
                            <label htmlFor="passwordInput">Nowe hasło</label>
                        </div>
                        <div className="form-floating mb-3">
                            <input
                                type="password"
                            ...
                            />
                            <label htmlFor="newpasswordInput">Potwierdz nowe hasło</label>
                        </div>
