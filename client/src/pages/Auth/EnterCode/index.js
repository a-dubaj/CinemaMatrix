...
function EnterCode(props) {
    ...
    const resendCode = (e) => {
        e.preventDefault();
        console.log('Wyślij ponowenie kod!');
    };
            ...
            <div className="row align-items-center g-lg-5">
                <div className="col-lg-7 text-start">
                    <p className="text-lg-start mt-3 fw-bold">
                        Ogólne informacje o
                        repertuarach, najnowsze zwiatsuny filmów.
                    </p>
                </div>
                <div className="col-md-10 mx-auto col-lg-5">
                    <form
                        ...
                        <h3>{isForgotPassword ? 'Odzywskiwanie hasła' : 'Weryfikacja adresu email'}</h3>
                        <p>
                            Wpisz otrzymany kod <span className="fw-bold">{email}</span> Sprawdz folder spam
                            jeśli nie masz kodu w skrzynce.{' '}
                            <a
                        ...
                        <div className="form-floating mb-3">
                            <input
                                ...
                                placeholder="000000"
                            />
                            <label htmlFor="codeInput">Wprowadz kod</label>
                        </div>
