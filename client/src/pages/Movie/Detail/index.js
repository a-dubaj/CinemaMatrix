            ...
            <Container className="w-60">
                <Row>
                    ...
                    <Col>
                        ...
                        <hr className="my-1" />
                        <div>
                            <span className="fw-bold">Dyrektor: </span>
                            <span>{movie.director}</span>
                        </div>
                        <div>
                            <span className="fw-bold">Obsada: </span>
                            <span>{movie.actor}</span>
                        </div>
                        <div>
                            <span className="fw-bold">Kategoria: </span>
                            <span>{movie.genre}</span>
                        </div>
                        <div>
                            <span className="fw-bold">Premiera: </span>
                            <span>{moment(movie.release_date).format('DD/MM/YYYY')}</span>
                        </div>
                        <div>
                            <span className="fw-bold">Długość filmu: </span>
                            <span>{movie.running_time} minut</span>
                        </div>
