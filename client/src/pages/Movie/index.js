        ...
        <main className="flex-shrink-0">
            <Container className="w-60">
                <h3 className="text-center">
                    {state === 'now-showing' ? 'Teraz w kinach' : 'Niedługo w kinie'}
                </h3>
                <Row md={4}>
                    {data.map((item, i) => {
                    ...
                    <span className="mt-1 text-line">
                      <span className="fw-bold ">Kategoria: </span>
                        {item.genre}
                                    ...
                                    <div className="px-0">
                                        <span className="fw-bold mt-1">Czas trwania: </span>
                                        <span>{item.running_time} minut</span>
                                    </div>
                                    <div className="px-0">
                                        <span className="fw-bold mt-1">Data premiery: </span>
