            ...
            {_.isEmpty(showtime) ? (
                ...
                <main className="flex-shrink-0">
                    <Container className="w-75">
                        <Row>
                            <h3 className="text-center">Rezerwacja biletu</h3>
                        </Row>
                        <Row>
                            <p className="fw-bold mb-0">
                                {showtime.Cinema.Cineplex.name} | {showtime.Cinema.name} | Miejsca ({resetSeats}/
                        ...
                        <div className="row mt-3">
                            ...
                            <div className="col-2 text-end px-0 me-1">
                                <p className="fw-bold mb-1">Kwota:</p>
